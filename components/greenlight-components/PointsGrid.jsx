        ...
        <Grid sx={styles.gridItem} item md={3} sm={6}>
          ...
          <Box className={"points"} sx={styles.body}>
            <Typography
              ...
              fontSize={10}
            >
              Every Member Automatically Earns Producer Points Based On Their
              Subscription.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid sx={styles.gridItem} item md={3} sm={6}>
          ...
          <Box className={"points"} sx={styles.body}>
            <Typography
              ...
              sm={6}
            >
              Contribute Your Producer Points Towards Any Project You Would Like
              To See Us Make.
            </Typography>
          </Box>
        </Grid>
        <Grid sx={styles.gridItem} item md={3} sm={6}>
          ...
          <Box className={"points"} sx={styles.body}>
            <Typography
              ...
              fontSize={10}
            >
              When Enough Members Contribute Points To Meet A {"Project’s"}{" "}
              Goal, We Make It.
            </Typography>
          </Box>
        </Grid>
