  ...
  return (
    <Box className={"active-tv-font"} sx={styles.container}>
      <Box style={{ color: "white" }} sx={styles.contentBox}>
        <Typography className={"active-tv-font"} style={{ fontSize: "20px" }}>
          Contact Us
        </Typography>
        <Typography
          className={"active-tv-font"}
          style={{ fontSize: "8px", marginTop: "10px" }}
        >
        ...
        <Typography
          className={"active-tv-font"}
          style={{ fontSize: "8px", marginTop: "40px" }}
        >
        ...
        <Box style={{ margin: "50px 0 0 0" }}>
          <Typography className="active-tv-font" style={{ fontSize: "8px" }}>
            Have you spotted a piece of our content being uploaded to a page not
            owned by Active TV?
          </Typography>
          <Typography
            className="active-tv-font"
            style={{ fontSize: "8px", margin: "30px 0 " }}
          >
            Email Address
          </Typography>
          <input
          ...
          <Typography
            className="active-tv-font"
            style={{ fontSize: "8px", margin: "20px 0 " }}
          >
            Name
          </Typography>
          <input
