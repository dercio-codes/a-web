        ...
        <Box sx={{ ...loginStyles.header }}>
          ...
          <Box className="flex justify-center items-center w-full h-screen  active-tv-font">
            <form id="paymentForm" className="p-5 shadow-lg space-y-8">
              <Box
                sx={{ width: "500px" }}
                className="space-x-4 flex justify-between items-center w-full"
              >
                <label
              ...
              <Box className="space-x-4 flex justify-between items-center w-full  active-tv-font">
                <label style={{ color: "#fff", fontSize: 12 }} htmlFor="email">
                  Email Address
                </label>
                <Box sx={{ display: "flex" }}>
                  <input
              ...
              <Box
                sx={{ marginBottom: 2 }}
                className="space-x-4 flex justify-between items-center w-full  active-tv-font"
              >
                <label
                  style={{
                    color: "yellow",
              ...
              >
                <select
                  style={{ height: "45px", width: "100", padding: "10px" }}
                  onChange={subscriptionType}
                >
                  <option style={{ height: "40px" }} value="annual">
                    Annual
                  </option>
